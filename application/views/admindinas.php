    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="tampiladmindinas">Dinas Kesehatan</a> 
            </div>
...
<a href="index" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="tampiladmindinas"><i class="fa fa-dashboard fa-3x"></i> Home</a>
                    </li>
        ...
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper" >
            <div id="page-inner">Selamat Datang</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
        </div>
